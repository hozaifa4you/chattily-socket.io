...
export type User = (typeof userDummyData)[number];
export type AuthUser = Omit<User, "bio">;
export type Message = (typeof messagesDummyData)[number];
